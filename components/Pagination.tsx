    ...
    <div id="pagination-section" className="mt-10 flex flex-col items-center gap-4">
      ...
      {hasMore && !loading && (
        <button
          id="load-more-btn"
          onClick={onLoadMore}
          className="group relative overflow-hidden rounded-xl border border-white/10 bg-white/[0.04] px-8 py-3 text-sm font-medium text-slate-200 backdrop-blur-xl transition-all duration-300 hover:border-indigo-500/40 hover:bg-indigo-500/10 hover:shadow-[0_0_24px_rgba(99,102,241,0.15)]"
        >
