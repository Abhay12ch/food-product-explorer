...
import type { SortOption, CategoryTag } from "@/types";
    ...
    <div id="controls-panel" className="w-full space-y-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-white/10 bg-white/[0.04] py-3 pl-12 pr-4 text-sm text-slate-100 placeholder-slate-500 backdrop-blur-xl transition-all duration-300 focus:border-indigo-500/50 focus:bg-white/[0.06] focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
        />
        {localSearch && (
          <button
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <div className="relative flex-1">
          <select
            ...
            className="w-full appearance-none rounded-xl border border-white/10 bg-white/[0.04] px-4 py-2.5 text-sm text-slate-200 backdrop-blur-xl transition-all duration-300 focus:border-indigo-500/50 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 cursor-pointer"
          >
        ...
        {hasFilters && (
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl border border-rose-500/20 bg-rose-500/10 px-4 py-2.5 text-xs font-medium text-rose-300 transition-all hover:bg-rose-500/20 hover:border-rose-500/40"
          >
